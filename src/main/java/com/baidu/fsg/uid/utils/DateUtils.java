...
public abstract class DateUtils {
    ...
    public static final DateTimeFormatter DATETIME_PATTERN = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
     ...
     */
    public static Date parseDate(String str, DateTimeFormatter pattern) {
    ...
    public static String formatByDayPattern(Date date) {
        if (date != null) {
            return LocalDateTime.ofInstant(date.toInstant(), ZoneId.systemDefault()).format(DAY_PATTERN);
        } else {
            return null;
        }
    }
    ...
    public static String formatByDateTimePattern(Date date) {
        return LocalDateTime.ofInstant(date.toInstant(), ZoneId.systemDefault()).format(DATETIME_PATTERN);
    }
    ...
    public static String getCurrentDayByDayPattern() {
        return LocalDateTime.now().format(DAY_PATTERN);
    }
