...
public class RingBuffer {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.baidu.fsg.uid.buffer.RingBuffer.class);
     ...
     */
    protected void discardPutBuffer(com.baidu.fsg.uid.buffer.RingBuffer ringBuffer, long uid) {
     ...
     */
    protected void exceptionRejectedTakeBuffer(com.baidu.fsg.uid.buffer.RingBuffer ringBuffer) {
