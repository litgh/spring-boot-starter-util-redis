 ...
 *
 * The {@link com.baidu.fsg.uid.impl.DefaultUidGenerator#parseUID(long)} is a tool method to parse the bits
 *
 * <pre>{@code
 * +------+----------------------+----------------+-----------+
...
public class DefaultUidGenerator implements UidGenerator {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.baidu.fsg.uid.impl.DefaultUidGenerator.class);
